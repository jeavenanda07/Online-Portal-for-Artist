...
import { isSessionTrue } from "@/app/actions/auth";
...
const Menu = ({ art }: any) => {
  ...
  useEffect(() => {
    const checkSession = async () => {
      setSession(await isSessionTrue())
      return;
    };
    checkSession();
  }, []);
    ...
    <div className="relative z-10 flex items-center gap-4">
      ...
      <div
        className={classNames(
          "absolute top-12 right-0 bg-primary border border-primary-line rounded-xl py-3 transition-all text-nowrap",
          {
