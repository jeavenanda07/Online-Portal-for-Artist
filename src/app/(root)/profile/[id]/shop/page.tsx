...
const ArtworkCardSkeleton = () => (
  ...
  >
    <div className="h-52 w-full" style={{ background: "#1a2e1a" }} />
    <div className="p-4 space-y-3">
      <div className="h-4 w-2/3 rounded-lg" style={{ background: "#1a2e1a" }} />
      <div className="h-3 w-1/3 rounded-lg" style={{ background: "#1a2e1a" }} />
      <div className="flex justify-between">
        <div className="h-5 w-16 rounded-lg" style={{ background: "#1a2e1a" }} />
        <div className="h-5 w-12 rounded-lg" style={{ background: "#1a2e1a" }} />
      </div>
    </div>
  </div>
);
  ...
  return (
    ...
    >
      <div className="px-6 py-4 flex justify-between items-center" style={{ borderBottom: "1px solid #1a2e1a" }}>
        <h3 className="font-black text-white">Edit Artwork</h3>
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <input
              type="number"
              className="w-full px-4 py-2.5 rounded-xl text-sm text-white outline-none disabled:opacity-30"
              style={{ background: "#0d0d0d", border: "1px solid #1a2e1a" }}
        ...
        >
          ...
          <input
            className="flex-1 min-w-[100px] bg-transparent outline-none text-sm text-white placeholder:text-zinc-600"
      ...
      <div className="px-6 py-4 flex justify-end gap-3" style={{ borderTop: "1px solid #1a2e1a" }}>
        <button onClick={onClose} className="px-5 py-2 rounded-xl text-sm font-bold text-zinc-500 hover:text-white transition-colors">
          Cancel
        </button>
        <button
          onClick={handleSave}
    ...
    >
      ...
      <div className="relative h-52 overflow-hidden">
        ...
        <div className="absolute top-3 right-3" ref={menuRef}>
          ...
          {menuOpen && (
            <div
              className="absolute top-10 right-0 w-36 rounded-xl overflow-hidden z-20 py-1"
              style={{ background: "#0d0d0d", border: "1px solid #1a2e1a", boxShadow: "0 8px 32px rgba(0,0,0,0.6)" }}
            >
              <button
                onClick={() => { onEdit(artwork); setMenuOpen(false); }}
                className="w-full flex items-center gap-3 px-4 py-2.5 text-xs font-bold text-white hover:bg-white/5 transition-colors"
              >
      ...
      {/* Info */}
      <div className="p-4">
        <h4 className="font-bold text-white text-sm truncate mb-1">{artwork.artwork_title}</h4>
  ...
  return (
    <div className="px-1">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h4 className="text-xl font-black text-white">Your Artshop</h4>
      ...
      {isLoading ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {[...Array(4)].map((_, i) => <ArtworkCardSkeleton key={i} />)}
        </div>
      ) : artworks.length === 0 ? (
        <div
        ...
        >
          ...
          <p className="font-bold text-white mb-1">No artworks yet</p>
